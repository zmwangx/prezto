...
alias gid='git diff --submodule --no-ext-diff --cached'
alias giD='git diff --submodule --no-ext-diff --cached --word-diff'
alias gir='git reset'
...
alias gwd='git diff --submodule --no-ext-diff'
alias gwD='git diff --submodule --no-ext-diff --word-diff'
